...
export const ProjectList = [
  {
    name: "HotelBookingProject",
    image: Proj1,
    description:"Developed a Travel Booking Application using a collaborative MERN stack. Enhanced data management through MongoDB clusters for seamless user experiences. Integrated advanced user authentication via Google OAuth and JWT for secure access. Designed a dynamic React-based interface for intuitive hotel searches, and integrated interactive maps using Leaflet to aid user decision-making during bookings.",
    skills: "React,Node.js,MongoDB,Leafle,GoogleAuthentication,Bootstrap",
    link:"https://master--vivid-wizard.netlify.app",
    login:"",
  ...
  },
  {
    ...
    login:"rahul,rahul@2021",
    gitLink:"https://github.com/TulasiSubrahmanyam/Jobby-App"
  },
  {
    name: "App Store",
    image: Proj4,
    ...
    gitLink:"https://github.com/TulasiSubrahmanyam/AppStore"
  },
  // {
